package br.com.projeto.restaurante.config.security;

import br.com.projeto.restaurante.repository.UsuarioRepository;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET, "/cardapio").permitAll()
			.antMatchers(HttpMethod.GET, "/cardapio/*").permitAll()
